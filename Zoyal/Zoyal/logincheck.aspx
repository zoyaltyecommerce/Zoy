...
<head>
    ...
    <link href="css/zoyalty.css" rel="stylesheet"/>
    <style>
...
@media (max-width: 1000px) {
  .welcome-message {
    display: none;
        ...
        #txt_username,#txt_password,.form-control {
        margin-bottom:15px;
        width:92%;
        }
        #btn_submit,#btn_forget {
            padding:7px 5px;
            border:0px;
            font-weight:bold;
        ...
        p.m-t{text-align:center;}
        h3 {
            text-align:center;
        }
        .logo-name{display:block;margin:auto;}
    </style>
       ...
       ControlToValidate="txt_fogetpassword" >
          ...
          <asp:Button ID="btn_submit" runat="server" class="btn btn-primary block full-width m-b" Text="Login" OnClick="btn_submit_Click" />
                ...
                <a id="forget" runat="server" href="#"  onclick="forgetpwd();" ><small>Forgot password?</small></a>
                  <a id="back" runat="server" href="shop-cart-full.aspx"><small>BACK</small></a>
